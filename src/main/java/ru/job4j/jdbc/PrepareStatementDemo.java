...
public class PrepareStatementDemo {
    ...
    public static void main(String[] args) throws Exception {
        City leningrad = new City(1, "Leningrad", 12);
        City stalingrad = new City(2, "Stalingrad", 13);
        PrepareStatementDemo psd = new PrepareStatementDemo();
        psd.insert(leningrad);
        psd.insert(stalingrad);
        System.out.println(psd.findAll().toString());
